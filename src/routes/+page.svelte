...
<div class="landing">
	...
	<section class="hero">
		...
		<div class="hero-content">
			...
			<p class="hero-sub sr-hero">
				Build responsive email templates with a drag-and-drop editor. Powered by MJML for
				pixel-perfect rendering across every client.
			</p>
	...
	<section id="features" class="section-dark">
		<div class="container">
			<div class="sr-bottom">
				...
				<p class="section-sub">
					A complete toolkit for designing production-ready email templates.
				</p>
			</div>
			...
			<div class="bento">
				<div class="bento-card bento-large sr-card">
					...
					<div class="bc-icon glass">
						<Icon name="codeBrackets" width={22} height={22} />
					</div>
					<h3>MJML Rendering</h3>
					<p>
						Production-ready HTML compiled from MJML. Works in Gmail, Outlook, Apple Mail, and every
						other client.
					</p>
				</div>
				<div class="bento-card bento-green sr-card">
					<div class="bc-icon green-icon">
						<Icon name="sun" width={22} height={22} />
					</div>
					<h3>Drag and Drop</h3>
					<p>
						Add headings, buttons, images, tables, and more. Reorder blocks with simple move
						controls.
					</p>
				</div>
				<div class="bento-card sr-card">
					...
					<h3>Theme System</h3>
					<p>
						Set a brand color once. It cascades to buttons, links, and accents across the entire
						template.
					</p>
				</div>
				<div class="bento-card bento-wide sr-card">
					...
					<p>
						Switch between desktop and mobile views instantly. Your emails look great on every
						screen size.
					</p>
				</div>
			</div>
	...
	<section class="marquee-section">
		<div class="container text-center sr-bottom">
			...
			<p class="section-sub" style="margin-left:auto;margin-right:auto;">
				From transactional to marketing, our templates handle every use case your business needs.
			</p>
		</div>
		...
		<div class="feature-strip">
			<div class="fs-card sr-card">
				<Icon name="codeBrackets" width={32} height={32} class="fs-icon" />
				<h3>Clean HTML output</h3>
				<p>
					Every template compiles to production-ready, table-based HTML that passes validation in
					all major clients.
				</p>
			</div>
			<div class="fs-card sr-card">
				<Icon name="image" width={32} height={32} class="fs-icon" />
				<h3>Image-first design</h3>
				<p>
					Drop in images, logos, and banners. They resize responsively and fall back gracefully when
					blocked.
				</p>
			</div>
			<div class="fs-card sr-card">
				<Icon name="gear" width={32} height={32} class="fs-icon" />
				<h3>Full customization</h3>
				<p>
					Every pixel is adjustable. Colors, padding, fonts, border radius, alignment - all editable
					in real time.
				</p>
			</div>
			<div class="fs-card sr-card">
				<Icon name="bag" width={32} height={32} class="fs-icon" />
				<h3>Ready to send</h3>
				<p>
					Export compiled HTML and use it with Axene Mailer, SendGrid, Mailchimp, or any ESP. Copy,
					paste, done.
				</p>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="steps">
				<div class="step sr-step">
					...
					<p>
						Start from a pre-built starter or create a blank canvas. Welcome emails, newsletters,
						invoices, and more.
					</p>
				</div>
				<div class="step sr-step">
					...
					<p>
						Add blocks, change colors, edit text, set your brand logo. Full control over every
				...
				<div class="step sr-step">
					...
					<p>
						Copy the compiled HTML or download it. Use it in Axene Mailer, your ESP, or any email
						platform.
					</p>
				</div>
			</div>
	...
	<section id="templates" class="section-dark">
		<div class="container">
			<div class="text-center sr-bottom">
				...
				<p class="section-sub" style="margin-left:auto;margin-right:auto;">
					Pre-built layouts for common email types. Customize colors, content, and branding.
				</p>
			</div>
			<div class="tpl-grid">
				<a href="/templates" class="tpl-card sr-card">
					<div class="tpl-thumb">
						<div class="tpl-wire">
							<div class="tw-hdr"></div>
							<div class="tw-bd">
								<div class="tw-ln w60"></div>
								<div class="tw-ln w40 dim"></div>
								<div class="tw-sp"></div>
								<div class="tw-ls"></div>
								<div class="tw-ls"></div>
								<div class="tw-ls w70"></div>
								<div class="tw-sp"></div>
								<div class="tw-bt"></div>
							</div>
						</div>
					...
					<div class="tpl-info">
						<span class="tpl-name">Welcome Email</span><span class="tpl-desc"
							>Greet new users and get them started</span
						>
					</div>
				</a>
				<a href="/templates" class="tpl-card sr-card">
					<div class="tpl-thumb" style="--tpl-hue:240">
						<div class="tpl-wire">
							<div class="tw-hdr"></div>
							<div class="tw-bd">
								<div class="tw-ln w50"></div>
								<div class="tw-sp"></div>
								<div class="tw-ls w80"></div>
								<div class="tw-ls"></div>
								<div class="tw-sp"></div>
								<div class="tw-bt"></div>
								<div class="tw-sp"></div>
								<div class="tw-ls w60 dim"></div>
							</div>
						</div>
						<span class="tpl-pill">Use</span>
					</div>
					<div class="tpl-info">
						<span class="tpl-name">Email Verification</span><span class="tpl-desc"
							>Confirm addresses with one-click</span
						>
					</div>
				</a>
				<a href="/templates" class="tpl-card sr-card">
					<div class="tpl-thumb" style="--tpl-hue:200">
						<div class="tpl-wire">
							<div class="tw-hdr"></div>
							<div class="tw-bd">
								<div class="tw-img"></div>
								<div class="tw-ln w70"></div>
								<div class="tw-ls"></div>
								<div class="tw-ls w80"></div>
								<div class="tw-bt" style="width:40%;margin:0"></div>
							</div>
						</div>
						<span class="tpl-pill">Use</span>
					</div>
					<div class="tpl-info">
						<span class="tpl-name">Newsletter</span><span class="tpl-desc"
							>Clean layout with image and CTA</span
						>
					</div>
				</a>
				<a href="/templates" class="tpl-card sr-card">
					...
					<div class="tpl-info">
						<span class="tpl-name">Invoice / Receipt</span><span class="tpl-desc"
							>Payment confirmation with table</span
						>
					</div>
				</a>
				<a href="/templates" class="tpl-card sr-card">
					<div class="tpl-thumb" style="--tpl-hue:0">
						<div class="tpl-wire">
							...
							<div class="tw-bd">
								...
								<div class="tw-bt"></div>
								<div class="tw-sp"></div>
								<div class="tw-ls w70 dim"></div>
							</div>
						</div>
						<span class="tpl-pill">Use</span>
					</div>
					<div class="tpl-info">
						<span class="tpl-name">Password Reset</span><span class="tpl-desc"
							>Secure link with expiry notice</span
						>
					</div>
				</a>
				<a href="/templates" class="tpl-card sr-card">
					...
					<div class="tpl-info">
						<span class="tpl-name">Blank Template</span><span class="tpl-desc"
...
<style>
	...
	.tpl-card:hover .tpl-wire {
		transform: scale(1.06) translateY(-2px);
	}
	.tw-hdr {
		height: 8px;
		background: hsla(var(--tpl-hue), var(--tpl-sat), 50%, 0.3);
	}
	.tw-bd {
		padding: 6px 8px 8px;
		display: flex;
	...
	.tw-bt {
		height: 6px;
		background: hsla(var(--tpl-hue), var(--tpl-sat), 50%, 0.25);
		border-radius: 3px;
		width: 50%;
		margin: 0 auto;
	}
